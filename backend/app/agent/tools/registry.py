        ...
        *,
        ...
        for tool in self.list_enabled():
            ...
            if spec.source == ToolSource.MCP.value and (
                ...
                continue
            if capability_id and spec.capability_id not in {capability_id, "shared", "common"}:
                continue
    ...
    def workspace_tool(
        ...
        *,
        ...
        spec = ToolSpec(
            ...
            integration_source="workspace_files",
            scope="workspace",
    ...
    def chat_tool(
        ...
        *,
        ...
        spec = ToolSpec(
            ...
            description=description,
            capability_id="paper",
            integration_source="paperdesk_library",
            scope=scope,
            operation_level=operation_level,
...
def _tool(
    ...
    *,
    ...
    spec = ToolSpec(
        ...
        integration_source="research_runtime",
        scope="research",
