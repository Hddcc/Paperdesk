...
| 章节 | 直达 |
| --- | --- |
| 1. 系统功能介绍 | [1.1 本地论文库管理](#11-本地论文库管理) · [1.2 AI 论文问答与分析](#12-ai-论文问答与分析) · [1.3 报告保存与-markdown-导出](#13-报告保存与-markdown-导出) · [1.4 论文分类与标签整理](#14-论文分类与标签整理) · [1.5 PDF 阅读与多页面入口](#15-pdf-阅读与多页面入口) |
| 2. 快速使用 | [2.1 环境要求](#21-环境要求) · [2.2 下载项目](#22-下载项目) · [2.3 配置后端环境变量](#23-配置后端环境变量) · [2.4 启动后端](#24-启动后端) · [2.5 配置并启动前端](#25-配置并启动前端) · [2.6 推荐使用流程](#26-推荐使用流程) · [2.7 常用校验命令](#27-常用校验命令) |
| 3. 项目结构 | [3.1 目录结构](#31-目录结构) · [3.2 运行结构视角](#32-运行结构视角) |
| 4. Agent 架构介绍 | [4.1 Agent 总体设计](#41-agent-总体设计) · [4.2 路由决策与运行路径](#42-路由决策与运行路径) · [4.3 上下文与记忆管理](#43-上下文与记忆管理) · [4.4 Agent Loop 与工具调用](#44-agent-loop-与工具调用) · [4.5 报告沉淀与研究任务](#45-报告沉淀与研究任务) · [4.6 扩展能力](#46-扩展能力) |
| 5. 联系方式 | [5. 联系方式](#5-联系方式) |
